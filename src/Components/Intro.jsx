                    ...
                    <Row className='mt-5'>
                        ...
                        <Col lg={8}>
                            <p className={context.munichTheme ? 'munich-intro-p d-none d-sm-block' : 'baires-intro-p d-none d-sm-block'}>
                                a passionate and creative frontend developer. I am very interested in <br /> technology and its potential to change and improve people's reality. I'm always looking<br /> for ways to improve and grow my skills. I specialize in HTML, CSS, JavaScript and React and I'm <br /> always eager to learn more about these technologies and how I can use them to build amazing things. <br /> Whether it's creating a visually appealing website or a complex application, I'm always up for the challenge.<br /> I'm excited about the future of technology and I can't wait to see what I'll be able to create in the years to come!
                            </p>
